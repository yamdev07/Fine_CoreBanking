...
async def seeded_db(db_session):
    ...
    e1 = make_entry(
        ...
        [("571100", 5000000, 0), ("101000", 0, 5000000)],
        1,
    )
    s.add(e1)
    await s.flush()
    for ln in make_lines(e1, [("571100", 5000000, 0), ("101000", 0, 5000000)], accs):
        s.add(ln)
    ...
    e2 = make_entry(
        ...
        [("251100", 1000000, 0), ("571100", 0, 1000000)],
        2,
    )
    s.add(e2)
    await s.flush()
    for ln in make_lines(e2, [("251100", 1000000, 0), ("571100", 0, 1000000)], accs):
        s.add(ln)
    ...
    e3 = make_entry(
        ...
        [("571100", 500000, 0), ("371100", 0, 500000)],
        3,
    )
    s.add(e3)
    await s.flush()
    for ln in make_lines(e3, [("571100", 500000, 0), ("371100", 0, 500000)], accs):
        s.add(ln)
    ...
    e5 = make_entry(
        ...
        [("663100", 12500, 0), ("371100", 0, 12500)],
        5,
    )
    s.add(e5)
    await s.flush()
    for ln in make_lines(e5, [("663100", 12500, 0), ("371100", 0, 12500)], accs):
        s.add(ln)
    ...
    e6 = make_entry(
        ...
        [("694100", 50000, 0), ("257000", 0, 50000)],
        6,
    )
    s.add(e6)
    await s.flush()
    for ln in make_lines(e6, [("694100", 50000, 0), ("257000", 0, 50000)], accs):
        s.add(ln)
