...
Readiness: are all dependencies available? (DB + Redis + Kafka bootstrap)
"""
import time
...
async def readiness():
    """
    Checks PostgreSQL, Redis (reporting cache), and Kafka bootstrap connectivity.
    ...
    # Kafka bootstrap connectivity check
    try:
