...
class TestListUsers:
    ...
    async def test_list_users_accountant_forbidden(
...
class TestGetUser:
    ...
    async def test_get_nonexistent_user_returns_404(
        ...
        res = await api_client.get(
            "/api/v1/users/00000000-0000-0000-0000-deadbeef1234", headers=admin_headers
        )
...
class TestDeactivateUser:
    ...
    async def test_cannot_deactivate_self_returns_400(
        self, api_client: AsyncClient, admin_headers: dict
    ):
    ...
    async def test_deactivate_nonexistent_user_returns_404(
        ...
        res = await api_client.delete(
            "/api/v1/users/00000000-0000-0000-0000-deadbeef5678", headers=admin_headers
        )
        assert res.status_code == 404
