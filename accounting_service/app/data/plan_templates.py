...
PCIMF_ACCOUNTS: list[AccountDef] = [
    ...
    AccountDef(
        "2",
        "ACTIFS IMMOBILISÉS",
        AccountClass.IMMOBILISE,
        AccountType.ACTIF,
        AccountNature.DEBITEUR,
        is_leaf=False,
    ),
    AccountDef(
        "21",
    ...
    AccountDef(
        "254000",
        "Crédits AGR (activités génératrices de revenus)",
        AccountClass.TIERS,
        AccountType.ACTIF,
        AccountNature.DEBITEUR,
        "25",
    ...
    AccountDef(
        "412000",
        "Frais et commissions à recouvrer",
        AccountClass.TIERS,
        AccountType.ACTIF,
        AccountNature.DEBITEUR,
        "41",
    ...
    AccountDef(
        "694100",
        "Provisions créances irrécouvrables",
        AccountClass.CHARGES,
        AccountType.CHARGE,
        AccountNature.DEBITEUR,
        "69",
...
PCEC_ACCOUNTS: list[AccountDef] = [
    ...
    AccountDef(
        "13",
        "Opérations interbancaires actif",
        AccountClass.CAPITAL,
        AccountType.ACTIF,
        AccountNature.DEBITEUR,
        "1",
    ...
    AccountDef(
        "14",
        "Opérations interbancaires passif",
        AccountClass.CAPITAL,
        AccountType.PASSIF,
        AccountNature.CREDITEUR,
        "1",
    ...
    AccountDef(
        "312000", "Obligations", AccountClass.STOCK, AccountType.ACTIF, AccountNature.DEBITEUR, "31"
    ),
    AccountDef(
        "32",
        "Titres de placement",
    ...
    AccountDef(
        "43",
        "Participations et titres détenus",
        AccountClass.TIERS,
        AccountType.ACTIF,
        AccountNature.DEBITEUR,
        "4",
    ...
    AccountDef(
        "452000", "Personnel", AccountClass.TIERS, AccountType.PASSIF, AccountNature.CREDITEUR, "45"
    ),
    AccountDef(
        "453000",
        "Impôts et taxes dus",
    ...
    AccountDef(
        "612000",
        "Intérêts sur emprunts interbancaires",
        AccountClass.CHARGES,
        AccountType.CHARGE,
        AccountNature.DEBITEUR,
        "61",
    ...
    AccountDef(
        "613000",
        "Intérêts sur refinancements BCEAO",
        AccountClass.CHARGES,
        AccountType.CHARGE,
        AccountNature.DEBITEUR,
        "61",
    ...
    AccountDef(
        "641000", "Loyers", AccountClass.CHARGES, AccountType.CHARGE, AccountNature.DEBITEUR, "64"
    ),
    AccountDef(
        "642000",
        "Frais informatiques",
    ...
    AccountDef(
        "711000",
        "Intérêts sur crédits court terme",
        AccountClass.PRODUITS,
        AccountType.PRODUIT,
        AccountNature.CREDITEUR,
        "71",
    ...
    AccountDef(
        "712000",
        "Intérêts sur crédits moyen terme",
        AccountClass.PRODUITS,
        AccountType.PRODUIT,
        AccountNature.CREDITEUR,
        "71",
    ...
    AccountDef(
        "713000",
        "Intérêts sur crédits long terme",
        AccountClass.PRODUITS,
        AccountType.PRODUIT,
        AccountNature.CREDITEUR,
        "71",
    ...
    AccountDef(
        "714000",
        "Intérêts sur placements interbancaires",
        AccountClass.PRODUITS,
        AccountType.PRODUIT,
        AccountNature.CREDITEUR,
        "71",
